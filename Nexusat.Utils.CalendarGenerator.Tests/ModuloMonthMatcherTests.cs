...
namespace Nexusat.Utils.CalendarGenerator.Tests
{
    ...
    public class ModuloMonthMatcherTests
    {
        ...
        public void TryParseTests()
        {
            ...
            Assert.IsTrue(ModuloMonthMatcher.TryParse("1..4%2", out var dateMatcher));
            ...
            Assert.IsTrue(ModuloMonthMatcher.TryParse("1..%3", out dateMatcher));
            Assert.IsNotNull(dateMatcher);
            Assert.AreEqual(1, dateMatcher.Left);
            Assert.AreEqual(12, dateMatcher.Right);
            Assert.AreEqual(3, dateMatcher.Modulo);
            Assert.IsTrue(ModuloMonthMatcher.TryParse("*%3", out dateMatcher));
            Assert.IsNotNull(dateMatcher);
            Assert.AreEqual(1, dateMatcher.Left);
            Assert.AreEqual(12, dateMatcher.Right);
            Assert.AreEqual(3, dateMatcher.Modulo);
