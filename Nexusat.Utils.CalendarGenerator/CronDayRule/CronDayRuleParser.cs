...
{
    public class CronDayRuleParser
    {
        private CronDayRuleParser()
        {
        }
        
        public static CronDayRuleParser Instance { get; } = new CronDayRuleParser();
...
(?<comments>#.*)?$".Replace("\n",""));
        ...
        /// </example>
        /// </summary>
        public bool TryParse(string value, out CronDayRule dayRule)
        {
            dayRule = default;
            ...
            dayRule = new CronDayRule(description, yearMatchers, monthMatchers, dayOfMonthMatchers, dayOfWeekMatchers, timePeriods);
