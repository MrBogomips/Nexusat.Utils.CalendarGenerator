...
``` 
 ...
 ## Calendar Examples
 For a working example please refer to the [Sample App](../blob/master/Nexusat.Utils.CalendarGenerator.SampleApp/Main.cs)
...
The calendar days table generated by the [Sample App](../blob/master/Nexusat.Utils.CalendarGenerator.SampleApp/Main.cs) are:
